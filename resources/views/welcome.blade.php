        ...
        <div class="container py-5">
            <div class="row g-5 align-items-center">
                <div class="col-md-12 col-lg-7">
                    <h4 class="mb-3 text-secondary">100% Organic Rice</h4>
                    <h1 class="mb-5 display-3 text-primary">Fresh & Organic Rice</h1>
                    ...
                    <div id="carouselId" class="carousel slide position-relative" data-bs-ride="carousel">
                        <div class="carousel-inner" role="listbox">
                            <div class="carousel-item active rounded">
                                <img src="img/hero-rice-1.jpg" class="img-fluid w-100 h-100 bg-secondary rounded" alt="First slide of organic rice">
                                <a href="#" class="btn px-4 py-2 text-white rounded">Jasmine Rice</a>
                            </div>
                            <div class="carousel-item rounded">
                                <img src="img/hero-rice-2.jpg" class="img-fluid w-100 h-100 rounded" alt="Second slide of organic rice">
