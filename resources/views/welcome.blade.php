                    ...
                    <div id="carouselId" class="carousel slide position-relative" data-bs-ride="carousel">
                        <div class="carousel-inner" role="listbox">
                            <div class="carousel-item active rounded">
                                <img src="{{asset('rice/1.png')}}" class="img-fluid w-100 h-100 bg-secondary rounded" alt="First slide of organic rice">
                                <a href="#" class="btn px-4 py-2 text-white rounded">Jasmine Rice</a>
                            </div>
                            <div class="carousel-item rounded">
                                <img src="{{asset('rice/2.png')}}" class="img-fluid w-100 h-100 rounded" alt="Second slide of organic rice">
